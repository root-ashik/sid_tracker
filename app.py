        ...
        if st.button(
            ...
            try:
                ...
                tracker_sheet.update_acell(
                    f"F{last_row}",
                    f'=HYPERLINK("{map_url}","📱 Track Route")'
                )
